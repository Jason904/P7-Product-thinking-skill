...
核心判断：
这不是一个视频生成工具升级，而是 creative AI 从资产工厂走向增长工作流的信号。最大机会不在生成更多视频，而在让营销团队用更低成本完成“洞察-创意-投放-数据-下一轮测试”的循环。真正要验证的也不是模型画面质量，而是它能否缩短实验周期、提高有效创意命中率、减少跨渠道改版成本，并让团队更快知道“什么内容能卖”。

行动取舍：
- 做：关注 Agent 是否能接入真实广告数据、生成可测试假设、产出多渠道变体并沉淀 learnings。
- 不做：不把“全用户可用”和“业务效果成立”混为一谈。
- 先验证：优先验证它是否改善广告测试速度、素材质量、转化指标和团队协作成本。
...
推导过程：受影响者是 founder、solo marketer、brand team、performance team、social team、product marketer、渠道平台和最终消费者。

再拆一层，founder 和 solo marketer 关注低成本启动增长实验；brand team 关注品牌一致性和审批风险；performance team 关注 CTR、CVR、ROAS 和 creative fatigue；social team 关注平台格式和发布节奏；product marketer 关注卖点表达和受众匹配。渠道平台虽然不是直接用户，却决定素材格式、投放信号和归因质量。
...
推导过程：变化发生在营销工作流中从创意构想到素材生产、数据分析、下一轮测试的连接段。

传统 creative AI 主要在“素材生产”这一段创造价值；Runway Agent 2.0 想进入的是生产前后的两段：生产前理解目标、受众和过往表现，生产后把指标反馈为下一轮创意方向。因此它的位置不是 design tool 的单点，而是 campaign workflow 的中间层，连接策略、生成、投放和复盘。

阶段结论：机会发生在数据反馈到下一轮创意之间。
...
推导过程：当前损失是创意产能不足、数据洞察无法及时转成新素材、跨平台改版成本高、测试周期长。

更关键的损失是“学习速度损失”：营销团队不是不知道要测试，而是每轮测试之间有太多摩擦。数据分析要等，brief 要写，设计要排期，品牌要审批，渠道格式要重做。等新素材上线时，用户兴趣、竞品动作和渠道算法可能已经变化。Agent 如果能把数据洞察直接转为下一轮可审核素材，就在缩短增长学习周期。
...
推导过程：营销团队想得到的是更快找到有效创意、更低成本跑更多实验、更稳定地把内容变成 revenue。

从 JTBD 看，用户雇佣 Runway Agent 不是为了“生成一条广告”，而是为了完成三个任务：第一，把模糊增长目标翻译成创意假设；第二，把假设变成多个可投放、可比较、符合品牌规范的素材；第三，把结果变成下一轮实验方向。只完成第二步，是生成工具；三步连起来，才是营销 agent。
...
推导过程：Runway、广告平台、品牌规范、投放数据、创意团队、审批机制和预算共同作用。

推力是渠道内容消耗加快、短视频/社媒格式碎片化、创意疲劳周期缩短和增长团队预算压力；阻力是数据授权、品牌一致性、归因噪声、合规审批和团队对 AI 内容质量的不信任；瓶颈是把广告表现变成明确创意假设；放大器是多平台格式生成、本地化、版本管理和自动复用。

阶段结论：系统变量决定 adoption。
...
推导过程：现在是 Agent 辅助创作和优化；阶段 1 是接入更多数据；阶段 2 是自动生成实验计划；长期是营销 agent 持续运行增长循环。

具体阶段是：现在，用户用 Agent 生成多平台 campaign 素材；阶段 1，Agent 读取历史素材、投放指标和品牌限制，给出创意角度；阶段 2，Agent 生成实验矩阵，包括受众、卖点、格式和渠道变体；长期形态是 agent 持续监控表现，提出下一轮假设并进入半自动增长运营。每个阶段的难度从生成能力转向数据权限和实验设计。

阶段结论：趋势是从生成工具走向 autonomous marketing workflow。
...
推导过程：价值从单次素材产出流向营销实验效率、增长学习和业务结果。

如果 Runway 只卖生成次数，价值会被模型价格和竞品工具压缩；如果它能证明“同样预算下更快找到有效创意”，价值就会进入增长预算而不是设计预算。控制点也会从模型能力迁移到数据连接、品牌记忆、实验设计、归因解释和跨渠道素材管理。
...
核心 Insight：Runway Agent 2.0 的核心不是“帮你做更多广告素材”，而是把 creative generation 放进营销实验闭环。

| 一级维度 | 子项 | 分值 | 得分 | 证据 | 扣分原因 | 补强动作 |
| --- | --- | ---: | ---: | --- | --- | --- |
| 思考深度 | 问题重构 | 8 | 8 | 将 Runway 从“广告素材生成”重构为“洞察-创意-投放-数据-下一轮测试”的增长实验闭环。 | 暂无结构性扣分。 | 后续用真实 campaign 数据验证。 |
| 思考深度 | 底层矛盾 | 8 | 7 | 识别营销团队想加快有效创意学习，但数据、品牌规范、渠道格式和审批流程割裂。 | 矛盾成立，但缺真实团队访谈。 | 补 founder、performance team 或 brand team 的使用反馈。 |
| 思考深度 | 因果机制 | 8 | 7 | 解释渠道竞争 -> 创意疲劳 -> 人工产能不足 -> 生成能力提升 -> 必须接入数据反馈才形成闭环。 | ROI 归因仍是弱证据。 | 用 A/B campaign 对比测试周期和 ROAS。 |
| 思考深度 | 系统关系 | 7 | 7 | 覆盖 Runway、广告平台、品牌规范、投放数据、创意团队、审批机制和预算。 | 暂无结构性扣分。 | 后续补渠道平台 API / 数据权限差异。 |
| 思考深度 | 反面论证 / 边界条件 | 7 | 7 | 明确如果不能把广告表现转化为下一轮假设，就仍是 creative assistant。 | 暂无结构性扣分。 | 持续拆分已发布能力与官方长期愿景。 |
| 思考深度 | 取舍判断 | 7 | 7 | 明确做数据反馈、实验假设、多渠道变体，不把全用户可用等同于商业效果成立。 | 暂无结构性扣分。 | 增加品牌一致性验收样例。 |
| 内容质量 | 事实可靠性 | 7 | 7 | 关键事实来自 Runway official news，AI HOT 仅作发现信号。 | 官方页偏产品叙事，不等于实际效果。 | 补客户案例、广告平台数据和第三方评测。 |
| 内容质量 | 背景解释 | 5 | 5 | 解释了 marketer、ad metrics、test/improve、platform formats 与 revenue 的关系。 | 暂无结构性扣分。 | 后续补竞品对比。 |
| 内容质量 | 信息颗粒度 | 6 | 5 | 已拆到 founder、solo marketer、brand team、performance team、CTR/CVR/ROAS、素材复用率。 | 缺公开 ROI 数字。 | 补真实 campaign 指标或用户案例。 |
| 内容质量 | 方法使用质量 | 6 | 6 | JTBD、双钻、利益相关者、North Star、反面论证均产出不同维度结论。 | 暂无结构性扣分。 | 保持方法服务洞察。 |
| 内容质量 | 趋势与机会信息 | 6 | 5 | 阶段推演从素材生成到实验矩阵再到 autonomous marketing workflow。 | 长期自动化仍主要是推演。 | 跟踪平台连接、数据权限和 attribution 能力。 |
| 表达质量 | 结论先行 | 5 | 5 | 开头明确“不是更多素材，而是营销实验闭环”。 | 暂无结构性扣分。 | 保持。 |
| 表达质量 | 结构清晰 | 5 | 5 | 从事实、方法、追问、8 问到六层表达完整。 | 暂无结构性扣分。 | 保持。 |
| 表达质量 | 推导可读 | 5 | 5 | 8 问逐步从角色、场景、损失、JTBD 推到增长实验系统。 | 暂无结构性扣分。 | 保持。 |
| 表达质量 | 口头表达 | 5 | 4 | 面试表达可讲清“素材工具 vs 增长系统”，但指标较多，需要压缩。 | 2 分钟版本仍可更锋利。 | 提炼 30 秒商业化版本。 |
| 表达质量 | 记忆点 | 5 | 5 | “用户买的不是素材数量，而是更快知道什么能卖”有记忆点。 | 暂无结构性扣分。 | 保持。 |
...
【趋势】
现在：Agent 生成和优化营销内容。阶段 1：接入更多表现数据和品牌规范。阶段 2：自动生成假设、变体和测试计划。长期形态：营销 agent 直接运行多渠道实验并持续学习。

【机会】
最大机会不在更多素材，而在更快完成从数据洞察到下一轮增长实验。
...
【验证指标】
创意产出周期、可测试变体数量、品牌审核通过率、CTR/CVR/ROAS、复用率、人工节省时间。

【最小可行方案】
选择一个小 campaign，用 Agent 生成 10 个创意变体并接入上一轮数据，与人工方案做两轮投放对比。

【长期机会】
形成面向中小团队和企业市场部的 autonomous marketing workflow。
...
第五，趋势上，现在：Agent 生成和优化营销内容。阶段 1：接入更多表现数据和品牌规范。阶段 2：自动生成假设、变体和测试计划。长期形态：营销 agent 直接运行多渠道实验并持续学习。
第六，机会判断上，最大机会不在更多素材，而在更快完成从数据洞察到下一轮增长实验。
...
价值流向：
从单次素材生成流向持续增长实验和业务结果。

做 / 不做 / 先验证：
做：验证 campaign iteration cycle。
不做：直接相信自主投放愿景。
先验证：数据导入、品牌一致性和投放效果。
